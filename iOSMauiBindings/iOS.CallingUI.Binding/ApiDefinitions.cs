...
namespace iOS.CallingUI.Binding
{
	...
	{
		// @property (copy, nonatomic) NSString * _Nonnull leaveCallConfirmationMode;
	...
	// @interface CaptionsOptionsProxy : NSObject
	[BaseType (typeof(NSObject), Name = "_TtC21CommunicationUI_Proxy20CaptionsOptionsProxy")]
	interface CaptionsOptionsProxy
	{
	...
	{
		// @property (copy, nonatomic) NSString * _Nonnull callScreenOrientation;
		[Export ("callScreenOrientation")]
		string CallScreenOrientation { get; set; }

		// @property (copy, nonatomic) NSString * _Nonnull setupScreenOrientation;
